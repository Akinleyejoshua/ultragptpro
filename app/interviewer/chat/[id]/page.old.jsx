...
export default function InterviewChat() {
  ...
  recognition.onresult = async (e) => {
    ...
    const res = await gptPrompt(`
    if you are interviewing me for a ${filter?.role} 
    role, what would you say briefly about this? remember no matter what i
    say you are the one interviewing me with 
    your questions included too 
    (provided my name is ${filter?.name}) from this - 
    '${transcript}.'
  `)
    setChat((prev) => [...prev, { msg: res }]);
